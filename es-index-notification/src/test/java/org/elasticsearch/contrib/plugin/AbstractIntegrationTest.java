...
public abstract class AbstractIntegrationTest {
    ...
    public static void beforeAllTests() throws IOException {
        ...
        Settings.Builder settings = Settings.settingsBuilder ( )
                ...
                .put("http.port", "9250")
                .put ("cluster.name", "test-cluster-" + InetAddress.getLocalHost ( ).toString ( ))
    ...
    private ClusterHealthResponse waitForGreenClusterState(String index) {
        ...
        ClusterHealthRequest request = new ClusterHealthRequestBuilder (clusterAdminClient, ClusterHealthAction.INSTANCE).setIndices (index).setWaitForGreenStatus ( ).request ( );
