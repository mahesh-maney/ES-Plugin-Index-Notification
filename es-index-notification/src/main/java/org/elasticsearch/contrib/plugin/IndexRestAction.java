...
public class IndexRestAction extends BaseRestHandler {
    ...
    @Inject
    public IndexRestAction(Settings settings, Client client, RestController controller) {
        ...
        this.executorService = EsExecutors.newScaling ("index-notification", 1, 10, 1, TimeUnit.MINUTES, EsExecutors.daemonThreadFactory ("es-index-notification"));
    }
